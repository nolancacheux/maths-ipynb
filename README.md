...
Pour exécuter les TP, vous devez installer Jupyter Notebook et les bibliothèques nécessaires (comme SageMath pour certains TP). Suivez les instructions sur [Jupyter.org](https://jupyter.org/) pour installer Jupyter Notebook. Pour installer SageMath, consultez les instructions sur [sagemath.org](https://www.sagemath.org/).
